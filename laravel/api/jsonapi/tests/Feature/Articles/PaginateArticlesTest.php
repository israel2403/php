...
class PaginateArticlesTest extends TestCase
{
    ...
    public function can_fetch_paginated_articles()
    {
        ...
        $url = route('api.v1.articles.indexOrderBy', ['page[size]' => 2, 'page[number]' => 3]);
        ...
        $response->assertJsonFragment([
            'first' => route('api.v1.articles.indexOrderBy', ['page[size]' => 2, 'page[number]' =>1]),
            'last' => route('api.v1.articles.indexOrderBy', ['page[size]' => 2, 'page[number]' =>5]),
            'prev' => route('api.v1.articles.indexOrderBy', ['page[size]' => 2, 'page[number]' =>2]),
            'next' => route('api.v1.articles.indexOrderBy', ['page[size]' => 2, 'page[number]' =>4]),
        ]);
    }
}
